...
class TrainingPipeline:
    ...
    def generate_visualizations(self, actual_prices, predicted_prices):
        ...
        history_plot_path = os.path.join(self.config.paths.PLOTS_DIR, 'training_history.png')
        Visualizer.plot_training_history(
            history=self.trainer.get_training_history(),
            save_path=history_plot_path
        )
        self.logger.info(f"✓ Training history plot saved")
        
        # Predictions plot
        predictions_plot_path = os.path.join(self.config.paths.PLOTS_DIR, 'predictions.png')
    ...
    def run(self):
        ...
        try:
            ...
            # Step 5: Generate visualizations
            self.generate_visualizations(actual_prices, predicted_prices)
